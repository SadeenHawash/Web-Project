...
if (isset($_GET['remove'])){
    ...
    //echo $remove_id;
    mysqli_query($con,"Delete from `bestseller` where productId =$remove_id ");
    header('location:adminBestSeller.php');
    ...
    <div id="js-scroll-content">
        <section class="tableView mt-5 pt-5 justify-content-center" style="padding: 40px">
            <div class="mt-5">
                <div class="col-lg-12">
                    <div class="sec-title text-center mb-5">
                        <h1 class="h1-title revealUp text-center">Best Sellers</h1>
                    </div>
                </div>
            </div>
            <table style="" class="table justify-content-end">
                ...
                <?php
                $stmt = $con->prepare("SELECT * FROM bestseller");
                $stmt->execute();
                $bestSeller = $stmt->get_result();
                while ($row = mysqli_fetch_assoc($bestSeller) ){
                    ...
                    <tr>
                        ...
                        <td>
                            <form>
                                <a href="adminBestSeller.php?remove=<?php echo $row['productId'] ?>">
